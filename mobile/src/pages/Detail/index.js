...
export default function Detail(){
    ...
    const message = `Olá ${incident.name}, estou entrando em contato poisgostaria de ajudar no caso "${incident.title}" com o valor de R$ ${incident.value}`
    ...
    function sendEmail(){
        MailComposer.composeAsync({
            subject: `Heroei do caso:${incident.title} ` ,
            recepients: [incident.email],
            body:MessageEvent,
        })
    }
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.contactBox}>
                ...
                <Text style={styles.heroTitle}>Seja o Heroe desse caso!</Text>

                <Text style={styles.heroDescription}>Entre em contato:</Text>

                <View style={styles.actions }>
                    <TouchableOpacity style={styles.ation} onPress={sendWhasapp}>
                    <Text style={styles.actionText}>Whasapp</Text>
                    </ TouchableOpacity>
                    <TouchableOpacity style={styles.ation} onPress={sendEmail}>
